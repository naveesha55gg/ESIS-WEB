...
if (isset($_POST['submit'])) {
    ...
    $sql = "insert into Company_Customer_Support(companyName,Email,Message)values('$companyName','$Email','$Message')";

    $result = mysqli_query($connection, $sql);

    if ($result) {
        //echo"Data inserted successfully";//
        header('location:displaysetting.php');
    } else {
...
<script>
  ...
  <a href="#contact">Privacy policy</a>
	...
	<div class="bg-img">
	 <form action="setting.php" method="POST" class="container">
	 <h1>Support ticket</h1>
        <div class="form-group">
            <label for="name"><h3>Company Name:</h3></label>
            <input type="text" id="name" name="companyName" required>
        </div>
		<br>
        <div class="form-group">
            <label for="email"><h3>Company Email:</h3></label>
