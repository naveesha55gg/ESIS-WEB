...
if (isset($_POST['submit'])) {
    ...
    $sql = "insert into companydash(companyName,address,website,Phone,password)values($companyName','$address','$website','$Phone','$password')";

    $result = mysqli_query($connection, $sql);

    if ($result) {
        //echo"Data inserted successfully";//
        header('location:displaydashbord.php');
    } else {
...
.btn:hover {
 ...
 <ul>
  ...
  <a href="#contact">Privacy policy</a>
	...
	<div class="bg-img">
	<form action="Dashbord.php" method="POST" class="container">
	<h1>Dashbord</h1>
    ...
    <label for="contactNumber"><h3>Contact Number:</h3></label>
    <input type="tel" id="contactNumber" name="Phone" ><br>
    ...
    <button type="submit" class="btn"name="submit">Edit Profile</button>
    </form>
	</div>
	</center>
 </body>
