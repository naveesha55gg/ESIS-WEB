...
if(isset($_POST['submit'])){
   ...
   $sql="insert into company(Email,companyName,address,website)values('$Email','$companyName','$address','$website')";
   
   $result=mysqli_query($connection,$sql);

   if($result){
    //echo"Data inserted successfully";//
    header('location:displaycompanydetails.php');
   }
   else{
...
<script>
  ...
  <a href="#contact">Privacy policy</a>
	...
	<div class="bg-img">
	<form action="Company Details.php" method="POST" class="container">
