...
if (isset($_POST['submit'])) {
    ...
    $recruitmentQualification = $_POST['recruitmentQualification'];

    $sql = "insert into Job_post(jobTitle,jobDescription,recruitmentQualification)values('$jobTitle','$jobDescription','$recruitmentQualification')";

    $result = mysqli_query($connection, $sql);

    if ($result) {
        //echo"Data inserted successfully";//
        header('location:displayCreateJobPost.php');
    } else {
...
<script>
  ...
  <a href="#contact">Privacy policy</a>
	...
	<div class="bg-img">
	<form action="Create Job Post.php" method="POST" class="container">
	<h1>Create Jobpost</h1>
    <label for="jobTitle"><h3>Job Title:</h3></label>

    <input type="text" id="jobTitle" name="jobTitle" rows="2" required>
    <br>
    <br>

    <label for="jobDescription"><h3>Job Description:</h3></label>
    ...
    <label for="recruitmentQualification"><h3>Recruitment Qualification:</h3></label>

    <textarea id="recruitmentQualification" name="recruitmentQualification" rows="10" required></textarea>
    <br>
    <br>

    <label for="jobImage"><h3>Job Post Image:</h3></label>
