...
<html>
  <head>
    ...
    <link rel="stylesheet" href="css/shedule_interviews.css" >
  </head>
  <body>
    <nav>
      <ul class="topnav">
	...
	<?php
$query = "
select i.*,c.CName,j.Jobtitle 
from interview i, Company c,Job_post j
where i.CID=c.CID and j.JobPID=i.JobPID";
...
if (mysqli_num_rows($result_set) > 0) {
    ...
    while ($row = mysqli_fetch_array($result_set)) {
        ?>
            ...
            <h3>Venue: <?php echo $row["Venue"] ?></h3>

            <button class="button">Shedule</button>
